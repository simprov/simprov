...
var revFiveYearBarChart = dc.barChart("#rev-trend-bar-chart", "revenue");
...
d3.csv("javascript/revenue_allYears.csv", function (data) {
            ...
            revFiveYearBarChart.yAxis().ticks(3).tickFormat(d3.format("s"));
                                            

            dc.dataCount("#rev-data-count", "revenue")
                    .dimension(ndx)
                    .group(all);

            dc.dataTable("#rev-data-table", "revenue")
                    .dimension(revenueByCampus)
                    .group(function (d) {
                        return d.campus;
                    })
            ...
            // revFiveYearBarChart.filter(2010);
