...
// Get chart instances
    let allDCCharts = await simprov.dcRegistry(1);
    console.log(allDCCharts);
    let [chart2, chart3, chart4, chart5, chart6] = allDCCharts;
    ...
    chartMap.set(chart2.chartID(), {
        ...
        type: 'clickChart',
        name: 'DriverChart',
        resetID: '#driverChartReset'
    });
    chartMap.set(chart3.chartID(), {
        registry: chart3,
        type: 'lapChart',
        name: 'LapChart',
        resetID: '#lapChartReset'
    });
    chartMap.set(chart4.chartID(), {
        registry: chart4,
        type: 'brushChart',
        name: 'SpeedChart',
        resetID: '#speedChartReset'
    });
    chartMap.set(chart5.chartID(), {
        registry: chart5,
        type: 'brushChart',
        name: 'AccChart',
        resetID: '#accChartReset'
    });
    chartMap.set(chart6.chartID(), {
        registry: chart6,
        type: 'brushChart',
        name: 'RadChart',
        resetID: '#radChartReset'
    });
