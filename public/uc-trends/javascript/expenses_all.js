...
d3.csv("javascript/expenses_allYears.csv", function (data) {
            ...
            var expensesByFunction2 = ndx.dimension(function (d) {
                return d.expenseFunction;
            });

            var expensesByFunctionGroup2 = expensesByFunction.group().reduceSum(function (d) { return d.amount; });
            ...
            console.log(expensesByYearGroup.all());
            ...
            functionPieChart.width(100)
                    ...
                    .radius(50)
                    .innerRadius(30)
                    .dimension(expensesByFunction2)
                    .title(function (d) { return ""; })
                    .group(expensesByFunctionGroup2)
                    .colors(expenseColors)
                    .renderLabel(false);
            ...
            expFiveYearBarChart.width(600)
                    ...
                    .elasticY(true)
                    .colors(['#737373'])
                    .xUnits(dc.units.ordinal)//function(){return 6;})
                    .elasticX(false)
                    .x(d3.scale.ordinal().domain([2008,2009,2010,2011,2012]))
                    .renderHorizontalGridLines(true)
            ...
            dc.dataCount("#exp-data-count", "expenditures")
                    .dimension(ndx)
                    .group(all);

            dc.dataTable("#exp-data-table", "expenditures")
                    .dimension(expensesByYear)
                    .group(function (d) {
                        return d.campus;
                    })
            ...
            // expFiveYearBarChart.filter(2010);
